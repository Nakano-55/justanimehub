...
const translations = {
  en: {
    ...
    contentManagement: 'Manage content translations and approvals',
    viewAll: 'View All',
  ...
  id: {
    ...
    rejected: 'Ditolak',
    pending: 'Menunggu',
    pendingTranslations: 'Terjemahan Menunggu',
    contentManagement: 'Kelola terjemahan dan persetujuan konten',
    viewAll: 'Lihat Semua',
